...
<div
    ...
    class="fixed top-5 right-5 max-w-xs w-full bg-white dark:bg-zinc-700 shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden z-50"
    style="display: none;"
>
    <div class="p-4">
